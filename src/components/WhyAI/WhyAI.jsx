  ...
  const features = [
    {
      ...
      title: 'Вы испытываете сложность в поиске подрядчиков',
    ...
    },
    {
      ...
      title: 'Не знате с чего начать трансформацию вашего бизнеса',
    ...
    {
      icon: 'carbon:roadmap',
      title: 'Нет чёткого плана внедрения новых методов бизнес-процессов',
